...
License data was checked through GitHub repository metadata and canonical repository files, most recently for the newly reviewed references on 2026-07-26. Re-check before making any stronger claim than broad inspiration.
...
| Matt Pocock Skills | https://github.com/mattpocock/skills | MIT | Broad inspiration for small composable Skills, explicit orchestration boundaries, completion criteria, primary-source research, and context-load discipline. |
