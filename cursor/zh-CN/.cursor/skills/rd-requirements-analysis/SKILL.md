...
description: >-
  ...
  (PRD/SRS). Use when the user has raw requirements, meeting notes, or feature
  requests to structure and analyze. 将模糊用户需求转化为结构化可验证的需求文档。
